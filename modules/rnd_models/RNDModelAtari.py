...
from modules.encoders.EncoderAtari import ST_DIMEncoderAtari, BarlowTwinsEncoderAtari, VICRegEncoderAtari, CNDVEncoderAtari
...
class CNDVModelAtari(nn.Module):
    def __init__(self, input_shape, action_dim, config):
        super(CNDVModelAtari, self).__init__()
        ...
        self.target_model = CNDVEncoderAtari(self.input_shape, self.feature_dim, config)
