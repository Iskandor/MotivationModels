...
from modules.PPO_Modules import PPOSimpleNetwork, PPOAerisNetwork, PPOAtariNetwork, PPOAtariNetworkFM, PPOAerisNetworkRND, PPOAerisNetworkDOPSimple, PPOAerisNetworkDOP
...
class PPOAerisDOPSimpleAgent(PPOAgent):
    def __init__(self, input_shape, action_dim, config, action_type):
        ...
        self.motivation = DOPSimpleMotivation(self.network.dop_model, config.forward_model_lr, config.forward_model_eta, self.memory, config.device)
        self.algorithm = self.init_algorithm(config, self.memory, action_type)
...
class PPOAerisDOPAgent(PPOAgent):
    def __init__(self, input_shape, action_dim, config, action_type):
        ...
        self.motivation = DOPMotivation(self.network.dop_model, config.forward_model_lr, config.forward_model_eta, self.memory, config.device)
        self.algorithm = self.init_algorithm(config, self.memory, action_type)
