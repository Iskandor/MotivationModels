...
class DDPGBulletDOPSimpleModelAgent(DDPGAgent):
    def __init__(self, state_dim, action_dim, config):
        super().__init__(state_dim, action_dim, config)
        self.network = DDPGBulletNetworkDOPSimple(state_dim, action_dim, config).to(config.device)
        self.memory = ExperienceReplayBuffer(config.memory_size)
...
class DDPGBulletDOPModelAgent(DDPGAgent):
    def __init__(self, state_dim, action_dim, config):
        super().__init__(state_dim, action_dim, config)
        self.network = DDPGBulletNetworkDOP(state_dim, action_dim, config).to(config.device)
