...
class ExperimentNoisyDDPG:
    ...
    def run_vae_forward_model(self, agent, trial):
        ...
        while steps < step_limit:
            ...
            print('Step {0:d} training [ext. reward {1:f} int. reward {2:f} VAE loss {3:f} steps {4:d}]'.format(steps, train_ext_reward, train_int_reward, train_vae_loss, train_steps))
            print(bar)
