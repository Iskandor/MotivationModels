...
if __name__ == '__main__':
    ...
    compute_metric_tensor('./base.npy', './tensor_base', batch=1000, gpu=0, lr=1e-3)
    compute_metric_tensor('./rnd.npy', './tensor_rnd', batch=1000, gpu=0, lr=1e-3)
    compute_metric_tensor('./cnd.npy', './tensor_cnd', batch=1000, gpu=0, lr=1e-3)
