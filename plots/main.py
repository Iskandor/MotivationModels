...
def atari_env(plots=True, tables=True):
    ...
    config = [
        ...
        # {'env': 'montezuma', 'algorithm': 'ppo', 'model': 'fwd', 'id': '45', 'legend': 'FWD'},
    ]
    ...
    config = [
        ...
        # {'env': 'gravitar', 'algorithm': 'ppo', 'model': 'fwd', 'id': '12', 'legend': 'FWD'},
    ]
    ...
    config = [
        ...
        # {'env': 'venture', 'algorithm': 'ppo', 'model': 'fwd', 'id': '7', 'legend': 'FWD'},
    ]
    ...
    config = [
        ...
        # {'env': 'pitfall', 'algorithm': 'ppo', 'model': 'fwd', 'id': '6', 'legend': 'FWD'},
    ]
    ...
    config = [
        ...
        # {'env': 'private_eye', 'algorithm': 'ppo', 'model': 'fwd', 'id': '6', 'legend': 'FWD'},
    ]
    ...
    config = [
        ...
        # {'env': 'solaris', 'algorithm': 'ppo', 'model': 'fwd', 'id': '6', 'legend': 'FWD'},
    ]
...
def procgen_env(plots=True, tables=True):
    ...
    config = [
        ...
        # {'env': 'coinrun', 'algorithm': 'ppo', 'model': 'fwd', 'id': '5', 'legend': 'FWD'},
    ]
    ...
    config = [
        ...
        # {'env': 'climber', 'algorithm': 'ppo', 'model': 'fwd', 'id': '5', 'legend': 'FWD'},
        {'env': 'climber', 'algorithm': 'ppo', 'model': 'cnd', 'id': '9', 'legend': 'SND-VINV'},
    ]

    # config = [
    #     {'env': 'climber', 'algorithm': 'ppo', 'model': 'cnd', 'id': '8', 'legend': 'SND-STD'},
    #     {'env': 'climber', 'algorithm': 'ppo', 'model': 'cnd', 'id': '9', 'legend': 'SND-STD'},
    #     {'env': 'climber', 'algorithm': 'ppo', 'model': 'cnd', 'id': '10', 'legend': 'SND-STD'},
    # ]
    ...
    config = [
        ...
        # {'env': 'jumper', 'algorithm': 'ppo', 'model': 'fwd', 'id': '5', 'legend': 'FWD'},
    ]
    ...
    config = [
        ...
        # {'env': 'caveflyer', 'algorithm': 'ppo', 'model': 'fwd', 'id': '5', 'legend': 'FWD'},
    ]
