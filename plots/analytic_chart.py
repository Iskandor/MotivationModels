...
def plot_detail_rnd_legacy(data, path, window=1000):
...
def plot_detail_fwd(data, path, window=1000):
    ...
    for i in tqdm(range(len(data))):
        ...
        plot_chart(num_rows, num_cols, 6, 'ext_value', data[i], window, color='blue', legend='extrinsic value')
        plot_chart(num_rows, num_cols, 7, 'int_value', data[i], window, color='red', legend='intrinsic value')
        plot_chart(num_rows, num_cols, 8, 'loss_target', data[i], window, color='red', legend='intrinsic value')
        plot_chart(num_rows, num_cols, 9, 'loss_fwd', data[i], window, color='red', legend='intrinsic value')
...
def plot_detail_baseline(data, path, window=1000):
    ...
    for i in tqdm(range(len(data))):
        ...
        plot_chart(num_rows, num_cols, 2, 'score', data[i], window, color='blue', legend='score')
        #plot_chart(num_rows, num_cols, 3, 'ri', data[i], window, color='red', legend='intrinsic reward')
#        plot_chart(num_rows, num_cols, 3, 'error', data[i], window, color='green', legend='error')
        #plot_chart(num_rows, num_cols, 5, 'loss_prediction', data[i], window, color='magenta', legend='loss prediction', legend_loc=9)
 #       plot_chart(num_rows, num_cols, 3, 'ext_value', data[i], window, color='blue', legend='extrinsic value')
  #      plot_chart(num_rows, num_cols, 4, 'int_value', data[i], window, color='red', legend='intrinsic value')
